...
#Preview {
    GymCardView(colorCategory: .purple, image: "Pull-Up-Strict", nom: "Pull-Up", scores: [10, 15, 20], dates: [Date(), Date().addingTimeInterval(-86400), Date().addingTimeInterval(-172800)])
}
