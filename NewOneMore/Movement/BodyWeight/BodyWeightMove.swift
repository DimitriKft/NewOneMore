...
let bodyWeightMoves = [
    // Street Workout
    BodyWeightMove(nom: "Pull-Up", subtitle: "Les tractions sont un exercice fondamental du street workout qui cible principalement les dorsaux et les bras.", imageName: "Pull-Up", category: .streetWorkout),
    BodyWeightMove(nom: "Muscle-Up", subtitle: "Le muscle-up combine une traction suivie d'un passage au-dessus de la barre, sollicitant tout le haut du corps.", imageName: "Muscle-Up", category: .streetWorkout),
    BodyWeightMove(nom: "Dips", subtitle: "Les dips sont un mouvement de poussée au poids du corps qui renforce les triceps, les épaules et les pectoraux.", imageName: "Dips", category: .streetWorkout),
    BodyWeightMove(nom: "Front Lever", subtitle: "Le front lever est un exercice de gainage avancé, où le corps est maintenu horizontal par la force des bras et du dos.", imageName: "Front-Lever", category: .streetWorkout),
    BodyWeightMove(nom: "Back Lever", subtitle: "Le back lever est un mouvement de force statique où le corps est maintenu horizontal face au sol, demandant un contrôle total du corps.", imageName: "Back-Lever", category: .streetWorkout),
    BodyWeightMove(nom: "Human Flag", subtitle: "La figure de drapeau humain est un mouvement impressionnant de street workout qui requiert une énorme force des épaules et des abdominaux.", imageName: "Human-Flag", category: .streetWorkout),
    BodyWeightMove(nom: "Pistol Squat", subtitle: "Le pistol squat est un squat unilatéral profond, exécuté sur une jambe pour renforcer les jambes et améliorer l’équilibre.", imageName: "Pistol-Squat", category: .streetWorkout),
    BodyWeightMove(nom: "Dragon Flag", subtitle: "Le dragon flag est un exercice avancé de renforcement des abdominaux, popularisé par Bruce Lee.", imageName: "Dragon-Flag", category: .streetWorkout),
    BodyWeightMove(nom: "One-Arm Pull-Up", subtitle: "Une version avancée de la traction, effectuée avec un seul bras, sollicitant intensément les dorsaux et les bras.", imageName: "One-Arm-Pull-Up", category: .streetWorkout),
    BodyWeightMove(nom: "Planche", subtitle: "La planche est un exercice de force statique dans lequel le corps est maintenu horizontalement avec les bras tendus.", imageName: "Planche", category: .streetWorkout),
    BodyWeightMove(nom: "Handstand Push-Up", subtitle: "Les pompes en équilibre sont une version avancée des pompes qui se concentrent sur la force des épaules et la stabilité du tronc.", imageName: "Handstand-Push-Up", category: .streetWorkout),
